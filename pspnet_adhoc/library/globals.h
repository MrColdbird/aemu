...
// Alert Flags
#define NET_ADHOC_F_ALERTSEND 0x0010
#define NET_ADHOC_F_ALERTRECV 0x0020
#define NET_ADHOC_F_ALERTPOLL 0x0040
#define NET_ADHOC_F_ALERTCONNECT 0x0080
#define NET_ADHOC_F_ALERTACCEPT 0x0100
#define NET_ADHOC_F_ALERTFLUSH 0x0200
#define NET_ADHOC_F_ALERTALL (NET_ADHOC_F_ALERTSEND | NET_ADHOC_F_ALERTRECV | NET_ADHOC_F_ALERTPOLL | NET_ADHOC_F_ALERTCONNECT | NET_ADHOC_F_ALERTACCEPT | NET_ADHOC_F_ALERTFLUSH)

// PDP Sockets
extern SceNetAdhocPdpStat * _pdp;

// PTP Sockets
extern SceNetAdhocPtpStat * _ptp;
